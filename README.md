...
- 当前 agent 工作目录：`/Users/brain/.openclaw/workspace-fullstack`
- 当前连着 GitHub 的本地仓库目录：`/Users/brain/.openclaw/daily-website-clean`
- GitHub Actions 与 Vercel 对齐到仓库内站点目录 `workspaces/fullstack-dev-assistant`
- 自动采集与自动部署已恢复正常
- 当前定时更新：**每天北京时间 08:00**
...
### 第 2 步：工作流切到真实站点目录执行
虽然 workflow 文件放在仓库根目录，但真正执行目录是仓库内路径：

- `workspaces/fullstack-dev-assistant`

如果映射到当前本机新的干净本地仓库，对应目录是：

- `/Users/brain/.openclaw/daily-website-clean/workspaces/fullstack-dev-assistant`

也就是说，下面这些命令实际都在该目录下执行：
...
### 1. 进入项目目录
```bash
cd /Users/brain/.openclaw/daily-website-clean/workspaces/fullstack-dev-assistant
```
...
- agent 对话工作目录保持为 `/Users/brain/.openclaw/workspace-fullstack`
- 连着 GitHub 的本地仓库目录改为 `/Users/brain/.openclaw/daily-website-clean`
- 实际站点源码目录为 `/Users/brain/.openclaw/daily-website-clean/workspaces/fullstack-dev-assistant`
- 不要再创建第二套重复站点目录
